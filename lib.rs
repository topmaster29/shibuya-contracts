...
pub mod my_psp34 {
	...
	impl PSP34 for Shibuya_psp34 {}
	impl Ownable for Shibuya_psp34 {}
	impl PSP34Burnable for Shibuya_psp34 {
		#[ink(message)]
	...
	impl PSP34Mintable for Shibuya_psp34 {
		#[ink(message)]
		#[openbrush::modifiers(only_owner)]
		fn mint(
            &mut self,
	...
	impl PSP34Enumerable for Shibuya_psp34 {}
	impl PSP34Metadata for Shibuya_psp34 {}
